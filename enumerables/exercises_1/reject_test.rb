...
class RejectTest < Minitest::Test
  ...
  def test_remove_numbers
    ...
    not_numbers = elements.reject do |i|
      i.class != String
    end
  ...
  def test_remove_floats
    ...
    not_numbers = elements.reject {|i| i.class == Float}
  ...
  def test_remove_arrays
    ...
    remaining = elements.reject {|i| i.class == Array}
  ...
  def test_remove_hashes
    ...
    remaining = elements.reject {|i| i.class == Hash}
